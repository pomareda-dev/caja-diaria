        ...
        <CardContent class="grid gap-6 lg:grid-cols-2">
            <div class="space-y-2">
                <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                        Mayor factor primero (ahorra en intereses).
                    </p>
                </div>
                <ol v-if="strategy.avalanche.length > 0" class="space-y-2">
                    <li
            ...
            <div class="space-y-2">
                <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                        Menor restante primero (gana motivación).
                    </p>
                </div>
                <ol v-if="strategy.snowball.length > 0" class="space-y-2">
                    <li
