    ...
    <Dialog :open="open" @update:open="closeDialog">
        <DialogContent class="sm:max-w-[425px]">
            <DialogHeader>
                ...
                <DialogDescription>
                    Ingresa el monto acordado de liquidación. Se creará un
                    único movimiento «Liquidación anticipada
                    {{ debt?.name }}» fechado hoy y se eliminarán las cuotas
                    proyectadas restantes. La deuda quedará cerrada como
                    historial.
                </DialogDescription>
            </DialogHeader>
