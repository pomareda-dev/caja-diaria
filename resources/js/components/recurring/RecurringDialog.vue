      ...
      >
        ...
        <div class="grid gap-2">
          ...
          <Input
            ...
            placeholder="0.00"
          />
          <p class="text-xs text-muted-foreground">Usa signo negativo para gastos (ej: -300.96)</p>
        ...
        <div class="grid gap-2">
          ...
          <Input
            ...
            type="date"
          />
          <p class="text-xs text-muted-foreground">Déjalo vacío para que se genere indefinidamente</p>
