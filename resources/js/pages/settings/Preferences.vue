...
import { setTheme, themeKey } from '@/composables/useAppearance';
        ...
        <div class="flex flex-wrap gap-3">
          <button
            ...
            :class="[
              ...
              themeKey === palette.key ? 'ring-2 ring-offset-2 ring-offset-background' : '',
            ]"
            :style="{
          ...
          >
            <span
              ...
              :class="themeKey === palette.key ? 'ring-1 ring-black/20 ring-inset dark:ring-white/20' : ''"
            />
