...
// --- Debt category ---
const debtCategoryValue = computed(() =>
    settings.debt_category_id ? String(settings.debt_category_id) : '',
);
    ...
    <div class="space-y-6">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Elige el diseño visual de la aplicación: colores, bordes,
                    sombras y espaciado
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div class="flex flex-wrap gap-3">
                    <button
                        ...
                        :class="[
                            'theme-' + palette.key,
                            'group relative flex size-10 items-center justify-center rounded-full focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:outline-hidden',
                    ...
                    >
                        <span
                            ...
                            :class="
                                themeKey === palette.key
                                    ? 'ring-1 ring-black/20 ring-inset dark:ring-white/20'
                                    : ''
                            "
                        />
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Sube una foto para que los demás te reconozcan. Formatos:
            ...
            <CardContent>
                <div class="flex items-start gap-6">
                    <Avatar class="size-20 overflow-hidden rounded-full">
                        ...
                        />
                        <AvatarFallback
                            class="rounded-full text-lg font-semibold"
                        >
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Controla el espaciado de los elementos en las tablas y
                    listas
                </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Se usará en los movimientos de desembolso, cuotas y
                    liquidaciones de tus préstamos.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Select
